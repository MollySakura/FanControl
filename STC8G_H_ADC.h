...
#ifndef	__STC8G_H_ADC_H
#define	__STC8G_H_ADC_H
...
#define 	ADC_PowerOn(n)			ADC_CONTR = (ADC_CONTR & ~0x80) | (n << 7)	/* ADC电源开关 */
#define 	ADC_Justify(n)			ADCCFG = (ADCCFG & ~(1<<5)) | (n << 5)			/* ADC转换结果格式控制, 左对齐/右对齐 */
